...
| --- | --- | --- | --- | --- |
| 아두이노 우노 | 1 | ATmega328P 마이크로 컨트롤러<br>입력 전압(권장) : 7~ 12V<br>디지털 I/O핀 : 14개(PWM 6개)<br>아날로그 입력 핀 : 6개
...
| Bluetooth 또는 WI-FI 모듈 | 작동 전압 : 3.3V ~ 5V <br>통신 방식 : UART(TX/RX) <br>통신 속도 : 9600bps(기본) <br>작동 범위 : 약 10m |  | 스마트폰과 우노 보드 통신 |  |
